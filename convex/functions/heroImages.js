...
export const updateHeroImage = mutation(async ({ db }, args) => {
...
// ✅ Delete a hero image
export const deleteHeroImage = mutation(async ({ db }, args) => {
